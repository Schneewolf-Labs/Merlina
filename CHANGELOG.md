...
### Changed
- **Training method selector moved to top of training tab**: The full "What are you training?" block (method description, Apply Suggested Settings button, preset notes) now lives at the top of Step 3. The dataset tab retains a compact select-only control for column-requirement awareness.
